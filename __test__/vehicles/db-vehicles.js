...
//     const validVehicles = new Vehicles(newCar);
//     const savedVehicles = await validVehicles.save();

//     // Object Id should be defined when successfully saved to MongoDB.
//     expect(savedVehicles._id).toBeDefined();
//     expect(savedVehicles.name).toBe(newCar.name);
//     expect(savedVehicles.category).toEqual(newCar.category);
//     expect(savedVehicles.typeOf).toEqual(newCar.typeOf);
//     expect(savedVehicles.axis).toBe(newCar.axis);
//     expect(savedVehicles.fuel_type).toBe(newCar.fuel_type);
//     expect(savedVehicles.weight).toBe(newCar.weight);
//   });
...
//   it('This will to avoid errors on the function', async () => {
//     // console.log(await Vehicles.createVehicle(newCar))
//     expect(await Vehicles.findAllVehicles('Hello world')).not.toBeNull();
//     expect(await Vehicles.findVehicleById('Hello world')).toBeNull();
//     expect(await Vehicles.findVehicleById(123)).toBeNull();
//     expect(await Vehicles.findVehicleById([])).toBeNull();
...
//   it('This will check the function of update Vehicles', async () => {
//     const newsVehicles = await Vehicles.createVehicle(newCar);
//     const id = newsVehicles._id;
...
//     const test = await Vehicles.updateVehicles(id, { costs: 0 });
//     expect(test.costs).toBeUndefined();
//   });

//   it('This check the function of delete an Vehicles', async () => {
//     expect(await Vehicles.deleteVehicle('Hello-world')).toBeNull();
//     // keep in mind
//     // expect(await Vehicles.deleteVehicle(123323412)).toBeNull()
//     expect(await Vehicles.deleteVehicle([])).toBeNull();
//     expect(await Vehicles.deleteVehicle({})).toBeNull();

//     const newsVehicles = await Vehicles.createVehicle({
//       name: "testing",
//       category: {
//         group1: 1,
//         group2: 1,
...
//     });
//     const id = newsVehicles._id;
//     expect(await Vehicles.deleteVehicle(id)).not.toBeNull();
